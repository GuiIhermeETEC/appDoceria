...
export default function CardSeries({titulo,imagem,nota, quantidade, peso, avaliacao}) {
    return(
        <TouchableOpacity style = {styles.containerJogos}>
            <Image style = {styles.images} source  ={require (`../../Img/infancia/Editado/${imagem}`)} ></Image>
