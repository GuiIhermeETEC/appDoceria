...
export default function CardGourmet({titulo,imagem,nota, quantidade, peso, avaliacao}) {
    return(
        <TouchableOpacity style = {styles.containerJogos}>
            <Image style = {styles.images} source  ={require (`../../Img/Gourmet/Editada/${imagem}`)} ></Image>
